...
## 10. WebDAV Tunnel (TCP over WebDAV Tunneling)
* **Назначение:** TCP-туннель поверх протокола WebDAV (режим selfhosted с встроенным WebDAV-сервером и relay в одном процессе), мультиплексирование потоков yamux с пулом 16 предварительно открытых потоков, шифрование чанков AES-256-GCM (scrypt KDF) и локальный SOCKS5-интерфейс на клиенте.
* **Оригинальный репозиторий:** [spkprsnts/webdav-tunnel](https://github.com/spkprsnts/webdav-tunnel)
* **Автор:** p1neappleXpress
* **Лицензия:** **MIT License**

...
Локальный HTTP-сервис подписок в составе X-Manager v2026.09.26.3. Хранит пользователей, ссылки, каталоги OpenFlux/WebDAV и клиентские группы автовыбора. Реализация: Python 3, стандартная библиотека, SQLite WAL, `ThreadingHTTPServer`.
